...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        img_zip=data_root + "bdd100k_images_100k.zip",
        img_prefix="bdd100k/images/100k/train/",
        seg_prefix={
            data_root + "da_seg_annotations.zip": "bdd_seg_gt/train/",
            data_root + "ll_seg_annotations.zip": "bdd_lane_gt/train/",
        },
        det_prefix={
            data_root
            + "det_annotations.zip": "data2/zwt/bdd/bdd100k/labels/100k/train/"
        },
        with_label=True,
        with_seg=True,
